...
<body>
<h2>请选择该组成员</h2>
  <s:form theme="simple" action="adminsavegroupmember">
<table class="list_table" align="left" width="640">
		...
		<s:iterator id="result" value="userlist" status="index">		
            ...
            <td width="25%" align="center">
                ...
                <s:checkbox name="isgroupmember[%{#index.index}]" theme="simple" value="selectedUserIdlist.get(#index.getIndex())"/>
				</td> 
