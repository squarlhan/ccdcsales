...
function createrow(mytable,a)
{
    ...
    td1.innerHTML = fhcks[a];
    td2.innerHTML = pchs[a];
    td3.innerHTML = prds[a];
    td4.innerHTML = sps[a];
    td5.innerHTML = wts[a];
    td6.innerHTML = "<span style='color=red'>销毁</span>";
}
function firstpage()
{
...
<s:form action="adminlistdestroy!listBetween.action">
	<table align="center" width="100%">
	  <tr align="center">
	  	<td width="20%">起始时间</td>
	     ...
	     <td width="20%"><s:submit value="查看销毁详情" theme="simple"/></td>
	  </tr>
	 </table>
