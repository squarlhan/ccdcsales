...
function setnumber(obj,line)
{
	...
	function checkNull()
	{
		...
		if(confirm("确认装车？")){
			document.myform.action = "cycdeliverytest.action";
			return true;
		}
		else
			return false;
	...
	function confirmPrintbtn()
	{
		...
		if(confirm("确认打印？")){
			document.myform.action = "cycdeliverytest!print.action";
			return true;
		}
		else
			return false;
  ...
  <table class="list_table"  id="tbt" align="center" width="100%">
   <tr>
           <td><s:text name="请填写备注"></s:text>
  	       ...
  	       <td><s:textfield name="memo" theme="simple" size="30"></s:textfield>
  	       </td>
