	...
	<body>
		<OBJECT classid=CLSID:8856F961-340A-11D0-A96B-00C04FD705A2 height=0
			id=WB width=0>
		         ...
		         <h2 align="center" class="STYLE1">产品移库确认</h2>
    			 <table width="90%" align="center" border="0" cellspacing="0">
    			 <tr>
    			 <td width="44%">
    			 <label class="STYLE3">客户名称：<%=request.getAttribute("customerName")%></label>
                 </td>
                 <td width="30%">
    			 <label class="STYLE3">发送日期：<%=request.getAttribute("date")%></label>
                 </td>
                 <td width="26%">
    			 ...
    			 <table width="90%" align="center" border="0" cellspacing="0">
				    ...
				    <td width="30%">
				    <label class="STYLE3">运输方式：<%=request.getAttribute("delivertypeName") %></label>	</td>
                    <td width="26%">
				    <label class="STYLE3">到站：<%=request.getAttribute("aim") %></label>	</td>
			       </tr>
    			</table>
                  <table width="90%" align="center" border="0" cellspacing="0">
				 	<tr>
				    <td width="44%">
				    <label class="STYLE3">到货仓库：<%=request.getAttribute("aimCangKu") %></label>
				 	</td>
				    <td width="30%">
				    <label class="STYLE3">销售类型：<%=request.getAttribute("saleTypeName") %></label>
				 	</td>
                    <td width="26%">
				    <label class="STYLE3">现行价：<%=request.getAttribute("price") %></label>
				 	</td>
				    </tr>
				  </table>
                  <table width="90%" align="center" border="0" cellspacing="0">
		...
		<form id="myform" action="xsliststorage.action">
		  <table width="90%" border="1" align="center" bordercolor="#000000" cellspacing="0" bgcolor="#F0F0F0" >
	    	<tr>
			  <th width="18%"  scope="col">发货仓库</th>
		        <th width="28%"  scope="col">产品名称</th>
			    <th width="18%"  scope="col">规格</th>
			    <th width="18%"  scope="col">应发吨数</th>
			    <th width="18%"  scope="col">应发件数</th>
			</tr>
