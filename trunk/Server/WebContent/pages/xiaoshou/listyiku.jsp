...
{
    location.href= encodeURI("xslistxsyk!delete.action?id="+bno); 
} 
...
//下面开始分页
	...
	var orgs = new Array(
		    <s:iterator id="result" value="xsyklist">
	...
	var aims = new Array(
		    <s:iterator id="result" value="xsyklist">
			    "<s:property value='#result.xsyikuxx.aimcanku.name'/>",
		    </s:iterator>
	    0);	
	var bnos = new Array(
			<s:iterator id="result" value="xsyklist">
...
<body>
<h2>移库单管理</h2>
<s:form theme="simple" action="xslistxsyk.action">
