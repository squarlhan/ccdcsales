...
<script language = "javascript" >
	...
	{
	    location.href= "cycdealwithlost.action?pch="+pch+"&pid="+pid+"&spid="+spid+"&lostvalue="+lostvalue; 
	} 
...
<h2>储运处损耗产品处理</h2>
<h3>储运处所有产品明细</h3>
<s:form id="myform" action="cycdealwithlost" theme="simple">
