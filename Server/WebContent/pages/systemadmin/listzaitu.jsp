...
<script language = "javascript" >
	...
	function createrow(mytable,a)
	{
		...
		td5.innerHTML = orgs[a];
		td6.innerHTML = aims[a];
		td7.innerHTML = wgts[a];
	}
...
<s:form id="myform" theme="simple">
 ...
 <tr>     
	<td><s:text name="源仓库:"/></td>
	<td><s:select  theme="simple" name="org" label="选择仓库名" labelposition="left" multiple="false" 
            list="cangkusList" listKey="id" listValue="name"/>
    </td>
    <td><s:text name="目标库:"/></td>
	<td><s:select  theme="simple" name="aim" label="选择仓库名" labelposition="left" multiple="false" 
            list="cangkusList1" listKey="id" listValue="name"/>
    </td>
    <td align="left">
		  <s:submit value="查看" theme="simple" action="adminlistonwayProducts!execute1"/></td>
 </tr>
</table>
