...
public class selectCangkuAction implements Preparable {
    ...
    public selectCangkuAction(ZhongZhuanKuService service) {
	...
	public String execute() 
	{
		...
		cankupriv.add(temp);
		System.out.println(cankupriv.size()+"------------------");
		session.put("zhongzhuanuser", cankupriv);
		System.out.println(((List<CankuPriv>) session.get("zhongzhuanuser")).size()+"------------------");
