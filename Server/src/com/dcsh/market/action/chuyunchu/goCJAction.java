...
public class goCJAction implements Preparable{
    ...
    private List<KcxxCheck> resultListTemp;
    private List<Canku> cankusList;
    private List<Custom> customList;
    private List<String> pchList;
    public goCJAction(WareHouseService service) {
	...
	public String execute() throws Exception {
    	...
    	if(user.size()==0) return "index";
    		...
    		cankusList = service.getCYCgck(user.get(0).getCanku().getId());
