...
public class goEntryyetiAction implements Preparable{
	private static final Logger log = LogManager.getLogManager().getLogger(goEntryyetiAction.class.getName());
    private WareHouseService service;
    private List<Products> productsList;
    private List<Canku> orginsList;
    private List<Specifications> specificationsList;

    public goEntryyetiAction(WareHouseService service) {
