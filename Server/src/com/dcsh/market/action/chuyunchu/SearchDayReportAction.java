...
public class SearchDayReportAction implements Preparable {
	...
	public String execute()  throws Exception
	{
		...
		this.reportcmxlist = this.service.getDayReportCmx(canku, new Date());
		    ...
		    if(((this.getBegindate()==null)||begindatestr.equals(nowstr))&&this.getEnddate().after(new Date())){
		        this.reportpmxlist = this.service.getDayReportPmx(canku, new Date());
				this.reportcmxlist = this.service.getDayReportCmx(canku, new Date());		
		}
		else
			if((this.getEnddate()==null||enddatestr.equals(nowstr)||this.getEnddate().after(new Date()))&&this.getBegindate().before(new Date())){
			...
			if(this.getBegindate().before(this.getEnddate())&&this.getEnddate().before(new Date())){
