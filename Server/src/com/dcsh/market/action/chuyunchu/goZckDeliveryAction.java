...
public class goZckDeliveryAction implements Preparable{
	private static final Logger log = LogManager.getLogManager().getLogger(goZckDeliveryAction.class.getName());
    ...
    public goZckDeliveryAction(WareHouseService service) {
	...
	public String execute() {
    	...
    	if(user.size()==0) return "index";
            ...
            this.resultList = service.getNxProducts(user.get(0).getCanku());
            ...
            cankusList = service.getCangkuByType(1);//×¤³§¿âÀàÐÍ 1
            return "show";
            }
